    ...
    <div class="flex items-center gap-6">
        ...
        <div class="hidden md:block relative">
            ...
            <input
                type="text"
                placeholder="Search..."
                class="w-72 pl-10 pr-4 py-2 bg-slate-100 border-transparent rounded-lg text-sm focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all placeholder-slate-400 text-slate-700">
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div
                    ...
                    <div class="p-4 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <span class="text-xs text-slate-500">2 Unread</span>
                    </div>

                    <ul class="divide-y divide-slate-100 max-h-64 overflow-y-auto">
                        <li class="p-4 hover:bg-slate-50 cursor-pointer">
                            <div class="text-sm font-medium text-slate-800">New seller application</div>
                            <div class="text-xs text-slate-500 mt-1">John Doe applied for a seller account.</div>
                        </li>
                        <li class="p-4 hover:bg-slate-50 cursor-pointer">
                            <div class="text-sm font-medium text-slate-800">Product approval pending</div>
                            <div class="text-xs text-slate-500 mt-1">Nike Air Max requires verification.</div>
                        </li>
                    </ul>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div
                    ...
                    <a href="{{ route('admin.profile.edit') }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                        Profile Settings
                    </a>
